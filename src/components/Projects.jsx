...
const projects = [
  {
    ...
    features: ['5 rating systems benchmarked on 10K synthetic 5v5 matches', 'Skill disparity 100.1 → 1.4 | 99.53% variance reduction', 'Smurf detection: 54.7% recall on 75 injected smurfs'],
  },
  {
    id: 'P-002',
    ...
    status: 'RESEARCH',
    year: 'Feb 2026',
    links: { github: 'https://github.com/valid22/cache-routing', live: null },
  ...
  },
  {
    ...
    description:
      'Engineered 12+ per-player behavioral features (entry rate, support score, role entropy, KDA, headshot rate) from real VCT and public competitive match data. Applied global and role-conditioned unsupervised clustering; role-conditioned archetypes were substantially more interpretable, revealing agent-behavior drift in public play (stable alignment 73% vs. 90% pro). Trained calibrated win-probability models (logistic regression, gradient boosting, MLP); best achieved ROC AUC 0.999 (pro) / 0.997 (public), improving Brier error 84% and 81% vs. a static strength-gap baseline.',
    tags: ['Python', 'scikit-learn', 'PyTorch', 'Streamlit', 'Clustering', 'Win Probability'],
    color: '#7B73FF',
    status: 'PROJECT',
    year: '2025',
    links: { github: 'https://github.com/valid22/valo-player-intel', live: 'https://project-intel.itsdote.tech/' },
    features: ['12+ behavioral features from VCT & public match data', 'ROC AUC 0.999 (pro) / 0.997 (public)', '84% / 81% Brier error improvement vs. static baseline'],
  },
  {
    id: 'P-005',
    name: 'RiboSense',
    ...
    status: 'RESEARCH',
    year: 'Jul 2025',
    links: { github: 'https://github.com/APalaniaLab/RiboSense', live: 'https://apalanialab.github.io/RiboSense/' },
